...
/**
 * The Responsibility REST controller. Is effectively thread safe.
 */
@RestController
...
public class ResponsibilityController {
    ...
    protected void checkConfiguration() {
        Helper.checkConfigNotNull(responsibilityService, "responsibilityService");
    }
    ...
    public Responsibility get(@PathVariable long id) throws MentorMeException {
        return responsibilityService.get(id);
    }
    ...
    @Transactional
    public Responsibility create(@RequestBody Responsibility entity) throws MentorMeException {
        return responsibilityService.create(entity);
    }
    ...
    @Transactional
    public Responsibility update(@PathVariable long id,
            @RequestBody Responsibility entity) throws MentorMeException {
        return responsibilityService.update(id, entity);
    }
    ...
    public SearchResult<Responsibility> search(@ModelAttribute ResponsibilitySearchCriteria criteria,
            @ModelAttribute Paging paging) throws MentorMeException {
        return responsibilityService.search(criteria, paging);
    }
}
