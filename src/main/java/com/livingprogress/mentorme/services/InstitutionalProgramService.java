...
/**
 * The institutional program service.
 * Extends generic service interface.Implementation should be effectively thread-safe.
*/
public interface InstitutionalProgramService
        extends GenericService<InstitutionalProgram, InstitutionalProgramSearchCriteria> {
}
