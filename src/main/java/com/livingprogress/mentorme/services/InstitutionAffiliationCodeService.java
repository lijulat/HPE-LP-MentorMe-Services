...
/**
 * The InstitutionAffiliationCode service.
 * Extends generic service interface.Implementation should be effectively thread-safe.
*/
public interface InstitutionAffiliationCodeService
        extends GenericService<InstitutionAffiliationCode, InstitutionAffiliationCodeSearchCriteria> {
}
