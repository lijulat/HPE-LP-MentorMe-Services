insert into user values(1,'test1', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname1', 'lastname1', 'email1@test.com', 'profilePicturePath1', '2016-10-01','ACTIVE', NULL, NULL, NULL, false, '7583 Classon Avenue', 'Brooklyn',32,230,'11205',-73.9617176,40.6978877, '2016-10-01');
insert into user values(2,'test2', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname2', 'lastname2', 'email2@test.com', 'profilePicturePath2', '2016-10-02','ACTIVE', NULL, NULL, NULL, true, '215 Park Ave', 'Brooklyn',32,230,'11205',-73.9702619,40.6962729, '2016-10-02');
insert into user values(3,'test3', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname3', 'lastname3', 'email3@test.com', 'profilePicturePath3', '2016-10-03','ACTIVE', NULL, NULL, NULL, false, '261 Moore St', 'Brooklyn',32,230,'11206',-73.9335866,40.7050622, '2016-10-03');
insert into user values(4,'test4', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname4', 'lastname4', 'email4@test.com', 'profilePicturePath4', '2016-10-04','ACTIVE', NULL, NULL, NULL, true, '54-29 Metropolitan Ave', 'Ridgewood',32,230,'11385',-73.9095494,40.7131197, '2016-10-04');
insert into user values(5,'test5', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname5', 'lastname5', 'email5@test.com', 'profilePicturePath5', '2016-10-05','INACTIVE', NULL, NULL, NULL, false, 'Suydam St', 'Ridgewood',32,230,'11385',-73.916849,40.708976, '2016-10-05');
insert into user values(6,'test6', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname6', 'lastname6', 'email6@test.com', 'profilePicturePath6', '2016-10-06','ACTIVE', NULL, NULL, NULL, true, '65-40 Grand Ave', 'Flushing',32,230,'11378',-73.8992662,40.7229976, '2016-10-06');
insert into user values(7,'test7', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname7', 'lastname7', 'email7@test.com', 'profilePicturePath7', '2016-10-07','ACTIVE', NULL, NULL, NULL, false, '59-63 54th Ave', 'Maspeth',32,230,'11378',-73.9065762,40.7306847, '2016-10-07');
insert into user values(8,'test8', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname8', 'lastname8', 'email8@test.com', 'profilePicturePath8', '2016-10-08','ACTIVE', NULL, NULL, NULL, true, '34-02 Greenpoint Ave', 'Maspeth',32,230,'11378',-73.9307031,40.7329573, '2016-10-08');
insert into user values(9,'test9', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname9', 'lastname9', 'email9@test.com', 'profilePicturePath9', '2016-10-09','ACTIVE', NULL, NULL, NULL, false, null, 'Brooklyn',32,230,'11222',-73.9506774,40.7282702, '2016-10-09');
insert into user values(10,'test10', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname10', 'lastname10', 'email10@test.com', 'profilePicturePath10', '2016-10-10','ACTIVE', NULL, NULL, NULL, true, null, 'Queens',32,230,'11101',-73.9418603,40.7443091, '2016-10-10');
insert into user values(11,'test11', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname11', 'lastname11', 'email11@test.com', 'profilePicturePath11', '2016-10-11','INACTIVE', NULL, NULL, NULL, false, '50-10 Northern Blvd', 'Long Island City',32,230,'11101',-73.91225,40.75210900, '2016-10-11');
insert into user values(12,'test12', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname12', 'lastname12', 'email12@test.com', 'profilePicturePath12', '2016-10-12','ACTIVE', NULL, NULL, NULL, true, '61-11 Fresh Pond Rd', 'Middle Village',32,230,'11379',-73.9010345,40.7142633, '2016-10-12');
insert into user values(13,'test13', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname13', 'lastname13', 'email13@test.com', 'profilePicturePath13', '2016-10-13','ACTIVE', NULL, NULL, NULL, false, '5602 31st Ave', 'Flushing',32,230,'11377',-73.905135,40.75681, '2016-10-13');
insert into user values(14,'test14', '$2a$10$x89u76j2IgiINI/LzVeXzOEq63VprctUKupS0QtPYGFd6JhzkBgke', 'firstname14', 'lastname14', 'email14@test.com', 'profilePicturePath14', '2016-10-14','ACTIVE', NULL, NULL, NULL, false, '54-19 Flushing Ave', 'Flushing',32,230,'11378',-73.913122,40.71549, '2016-10-14');
...
insert into institutional_program values (1, 'programName1', '2016-10-11','2016-10-31',1,1,20, '2016-10-10','programImageUrl1', '2016-10-10');
insert into institutional_program values (2, 'programName2', '2016-10-12','2016-10-21',2,2,10, '2016-10-11','programImageUrl2', '2016-10-11');
insert into institutional_program values (3, 'programName3', '2016-10-13','2016-10-20',3,3,8, '2016-10-12','programImageUrl3', '2016-10-12');
insert into institutional_program values (4, 'programName4', '2016-10-14','2016-10-19',4,1,7, '2016-10-13','programImageUrl4', '2016-10-13');
insert into institutional_program values (5, 'programName5', '2016-10-15','2016-10-18',5,2,6, '2016-10-14','programImageUrl5', '2016-10-14');
insert into institutional_program values (6, 'programName6', '2016-10-16','2016-10-17',6,3,5, '2016-10-15','programImageUrl6', '2016-10-15');
...
insert into activity values(1, 1, 'GOAL_CREATED', 1, 'description1', 1, '2016-10-01',4, 3, true, 1, '2016-10-01');
insert into activity values(2, 2, 'GOAL_UPDATED', 2, 'description2', 2, '2016-10-02',10, 5, false, 2, '2016-10-02');
insert into activity values(3, 3, 'TASK_CREATED', 3, 'description3', 3, '2016-10-03',11, 6, true, 3, '2016-10-03');
insert into activity values(4, 4, 'TASK_UPDATED', 4, 'description4', 4, '2016-10-04',12, 7, false, 4, '2016-10-04');
insert into activity values(5, 5, 'EVENT_CREATED', 5, 'description5', 5, '2016-10-05',13, 8, true, 5, '2016-10-05');
insert into activity values(6, NULL , 'EVENT_UPDATED', 6, 'description6', 6, '2016-10-06',NULL, NULL, false, 6, '2016-10-06');
...
insert into document values(1,'name1', 'path1', 1, '2016-10-01', 1, '2016-10-01');
insert into document values(2,'name2', 'path2', 2, '2016-10-02', 2, '2016-10-02');
insert into document values(3,'name3', 'path3', 3, '2016-10-03', 3, '2016-10-03');
insert into document values(4,'name4', 'path4', 4, '2016-10-04', 4, '2016-10-04');
insert into document values(5,'name5', 'path5', 5, '2016-10-05', 5, '2016-10-05');
insert into document values(6,'name6', 'path6', 6, '2016-10-06', 6, '2016-10-06');
