...
DELETE FROM `mentee_mentor_responsibility`;
DELETE FROM `mentee_mentor_program_useful_link`;
...
DELETE FROM `skill`;
DELETE FROM `mentee_mentor_program_request`;
DELETE FROM `country_locale`;
DELETE FROM `locale`;
DELETE FROM `personal_interest_locale`;
DELETE FROM `professional_consultant_area_locale`;
DELETE FROM `professional_interest_locale`;
DELETE FROM `skill_locale`;
DELETE FROM `state_locale`;
DELETE FROM `institutional_program_skill`;
